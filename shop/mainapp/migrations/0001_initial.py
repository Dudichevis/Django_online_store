    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd_volume_max', models.CharField(max_length=255, verbose_name='Максимальный обьем памяти')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_without_charge', models.CharField(max_length=255, verbose_name='Время заряда батареи')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.category', verbose_name='Категория')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='cart',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.customer', verbose_name='Владелец товара'),
        ),
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, related_name='related_cart', to='mainapp.CartProduct', verbose_name=''),
        ),
    ]
